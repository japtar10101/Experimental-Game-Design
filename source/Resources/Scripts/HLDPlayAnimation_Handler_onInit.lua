...
--------------------------------------------------------------------------------
function HLDPlayAnimation.onInit (  )
--------------------------------------------------------------------------------
    ...
    then
        ...
        if (  tag == "" )
        then
            log.error ( "HLDPlayAnimation : You must specify a target for object ", this.getObject ( ) )
        else
            ...
            then
                ...
                log.error ( "HLDPlayAnimation : Could not find object with the tag \'", tag, "\'." )
            end
        end
    end
