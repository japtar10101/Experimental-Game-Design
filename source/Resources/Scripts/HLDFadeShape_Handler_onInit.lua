...
--------------------------------------------------------------------------------
    ...
    then
        ...
        if (  tag == "" )
        then
            log.error ( "HLDFadeShape : You must specify a target for object ", this.getObject ( ) )
        else
            ...
            then
                ...
                log.error ( "HLDFadeShape : Could not find object with the tag \'", tag, "\'." )
            end
        end
    end
