...
--------------------------------------------------------------------------------
    ...
    then
        ...
        if (  tag == "" )
        then
            log.error ( "HLDBlinkShape : You must specify a target for object ", this.getObject ( ) )
        else
            ...
            then
                ...
                log.error ( "HLDBlinkShape : Could not find object with the tag \'", tag, "\'." )
            end
        end
    end
