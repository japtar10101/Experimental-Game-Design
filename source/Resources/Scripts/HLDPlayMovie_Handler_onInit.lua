...
--------------------------------------------------------------------------------
    ...
    then
        ...
        if (  tag == "" )
        then
            log.error ( "HLDPlayMovie : You must specify a target for object ", this.getObject ( ) )
        else
            ...
            then
                ...
                log.error ( "HLDPlayMovie : Could not find object with the tag \'", tag, "\'." )
            end
        end
    end
